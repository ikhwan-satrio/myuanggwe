...
export default defineConfig({
	plugins: [
		Components({
			dirs: ['src/lib/components/ui', 'src/lib/components/utils'],
		...
		AutoImport({
			...
			imports: [
				...
				'svelte/store',
				{
					'@tanstack/svelte-query': ['useQueryClient', 'createQuery', 'createMutation'],

					'@tanstack/svelte-form': ['createForm'],
					// MANUAL NAMESPACE MAPPING
					'$lib/utils': ['cn'],
					'$lib/components/ui/button': ['buttonVariants'],
